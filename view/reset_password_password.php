...
<form class="formLogin" action="../index.php?action=newpasswordform" method="post">
  <label for="newpassword"><?php echo I('reset_new_password');?></label> <br>
  <input class="formText" type="password" name="newpassword" value="" required> <br>
  <label for="newpassword2">
    <?php echo I('reset_repeat_password');?>
  </label> <br>
  <input class="formText" type="password" name="newpassword2" value="" required> <br>
