...
<h2><?echo I('sign_registration');?></h2>

<form id="formSignUp" action="../index.php?action=signUp" method="post">
  <label for="username"><?echo I('login_username');?></label> <br>
  ...
  <label for="password"><?echo I('login_password');?></label> <br>
  ...
  <label for="repeatpassword"><?echo I('sign_confirm_password');?></label> <br>
  ...
  <label for="email"><?echo I('sign_email');?></label> <br>
...
<p><?echo I('sign_I_already_have_account');?></p>
<form action="index.php?action=haveAccountLink" method="post">
    <button type="submit" name="" value="" class="btn-link"><?echo I('sign_login');?></button>
</form>
